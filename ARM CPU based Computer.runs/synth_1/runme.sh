...
HD_PWD='C:/Users/Shreshth Tuli/Desktop/COL216 Labs/ARM CPU based Computer/ARM CPU based Computer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_datapath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_datapath.tcl

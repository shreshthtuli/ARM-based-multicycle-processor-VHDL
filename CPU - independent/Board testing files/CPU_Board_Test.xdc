...
set_property PACKAGE_PIN T18 [get_ports clk_cont]
set_property IOSTANDARD LVCMOS33 [get_ports clk_cont]

set_property PACKAGE_PIN R2 [get_ports data_select]
set_property IOSTANDARD LVCMOS33 [get_ports data_select]
